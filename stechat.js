...
var Stechat = {
        ...
        ajaxParam = {
            ...
            onSuccess: function (transport) {
                if (! Stechat.isBlank(transport.responseText)) {
                    handlerResult = handler(eval(transport.responseText));
                }
    ...
    startAutoReload: function () {
        if (Stechat.__reloader === null) {
            Stechat.__reloader = new PeriodicalExecuter(function (pe) {
...
Event.observe(window, 'load', function () {
    ...
    if ($('utterance')) {
        ...
        Event.observe('cont', 'keydown', function (e) {
        ...
        Event.observe('num', 'keydown', function (e) {
